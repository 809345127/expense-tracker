...
enum DemoData {
    static func makeInMemoryContainer() -> ModelContainer {
        ...
        let container = try! ModelContainer(for: Expense.self, Tag.self, configurations: config)
        ...
        let samples: [(daysAgo: Int, time: String, amount: Double,
                       category: ExpenseCategory, note: String,
                       tags: [String], createdAfter: TimeInterval, isPrivate: Bool)] = [
            (0,  "12:18:32", 24.5, .food,          "午饭·公司楼下面馆", [],                 47, false),
            (0,  "09:02:15", 4,    .transport,     "地铁",             ["出差", "可报销"],  92, false),
            (1,  "21:58:44", 15,   .transport,     "打车",             ["出差", "可报销"],  55, false),
            (1,  "19:35:20", 128,  .entertainment, "电影两张票",        ["请客"],       58_020, true),   // 第二天早上才补记
            (1,  "12:41:07", 32.8, .food,          "午饭",             [],                 63, false),
            (2,  "20:07:53", 349,  .shopping,      "键帽，\"矮轴\" 一套", ["大件"],           120, false),
            (2,  "15:22:09", 25,   .food,          "咖啡",             [],                 71, false),
            (3,  "18:44:31", 68,   .food,          "周末火锅 AA",       ["请客"],      180_960, false),   // 隔了两天才想起来补
            (3,  "08:15:06", 10,   .transport,     "共享单车月卡",      [],                 40, false),
            (5,  "19:12:38", 52.5, .food,          "晚饭",             [],                 66, false),
            (5,  "10:00:00", 99,   .subscription,  "iCloud + 视频会员",  ["可报销"],         300, false),
            (6,  "11:30:00", 200,  .social,        "同事结婚随礼",      ["请客"],         3_600, true),
            (8,  "13:27:41", 45,   .education,     "技术书",           ["可报销"],          95, false),
            (8,  "09:45:12", 1860, .housing,       "房租水电分摊",      [],                 180, false),
            (10, "16:50:23", 30,   .medical,       "感冒药",           [],                  58, false),
            (11, "12:33:17", 88,   .food,          "日料午市",          ["请客"],            74, false),
            (34, "12:20:44", 21.5, .food,          "午饭",             [],                  61, false),
            (35, "10:05:00", 3200, .housing,       "房租",             [],                 240, false),
            (36, "21:14:29", 599,  .shopping,      "降噪耳机",          ["大件"],           150, false),
            (40, "08:33:52", 12,   .transport,     "地铁",             ["出差"],             45, false),
        ]
        for s in samples {
            ...
            let expense = Expense(amount: Decimal(s.amount), category: s.category, note: s.note,
